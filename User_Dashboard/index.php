  ...
  <div class="hero_area">
    ...
    <div class="mydiv" >
      <div id="triangle-down">
        <h6 class="welc"> سلام .. خوش آمدی   |    برای برقراری ارتباط و شروع دوره مربی مورد نظرت رو انتخاب کن </h6>
        <a href=""><h6 class="exi">خروج <img class="bb" src="images/logout.png" alt=""> </h6></a>
      </div>
      <div class="insidediv">
        <?php
            foreach($coaches as $coach)
            {
                ...
                $coachsp = $coach['specialty'];
                $href = "/Tandorost/Select_Coach/index.php?cid=" . $coach['cid'] . "&uid=" . $uid;
                $bb = data_uri($coach['photo'],'image/png');
                echo "<a href='$href'><div class='insidesidediv'><img class='imgc' src='$bb' alt=''><p class='myh5'>$coachname </p><p class='myh6'>$coachsp</p></div></a>";
